...
{
	document.querySelectorAll('.fade-on-scroll').forEach(elem => elem.classList.add('on-screen'));
...
else
{
	...
	document.querySelectorAll('.fade-on-scroll').forEach(elem => handle_on_screen(elem));

	// Recalculate on-screen class on every scroll.
	document.addEventListener('scroll', _ => document.querySelectorAll('.fade-on-scroll').forEach(elem => handle_on_screen(elem)));

	// The same goes for window resizing
	window.addEventListener('resize', _ => document.querySelectorAll('.fade-on-scroll').forEach(elem => handle_on_screen(elem)));

	console.log('fade enabled')
}
